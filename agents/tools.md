...
NOTE: Not a coding agent harness. Monorepository of simple LLM-based AI tools serving as companion code/examples for the BuildOwn.AI book. Includes a chapter_summarizer tool. Very early stage (3 commits, 1 star).
