...
An agile methodology framework for AI-driven development covering the entire delivery lifecycle -- from clarifying vague ideas to planning, building, verifying, and learning -- preserving durable context across sessions with specialized agent perspectives.
