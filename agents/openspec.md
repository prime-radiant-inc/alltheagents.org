...
Adds a lightweight spec layer for AI coding assistants to agree on what to build before code is written, using an artifact-guided workflow with plain Markdown; supports 30+ tools and enables cross-repo planning via 'Stores.'
