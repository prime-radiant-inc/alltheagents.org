...
Originally a GitHub-app AI coding assistant; pivoted to an AI coding assistant for JetBrains IDEs, distributed as a JetBrains plugin. Dual-licensed: MIT for the free software portion, EE License for the enterprise portion.
