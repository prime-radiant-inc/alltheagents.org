...
GitLab Orbit lifecycle context graph connecting code, merge requests, pipelines, and deployments for agent grounding; AI Catalog for agent/flow management; policy-driven AI control; event-driven agentic flows with full CI/CD traceability.
